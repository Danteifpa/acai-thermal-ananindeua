  ...
  return (
    <div className="space-y-8 animate-in fade-in duration-500">
      <header className="flex flex-col gap-1">
        <h1 className="text-4xl font-black text-slate-900 tracking-tight">Padrões de Segurança</h1>
        <p className="text-slate-500 text-lg">Normas técnicas para a eliminação de patógenos no processamento do Açaí.</p>
      </header>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <Card className="bg-white border-slate-200 p-8 space-y-4 shadow-sm">
          <div className="bg-emerald-50 w-12 h-12 rounded-xl flex items-center justify-center">
            <ShieldCheck className="text-[#1E562F]" size={28} />
          </div>
          <h3 className="text-2xl font-bold text-slate-900">A Regra dos 52.5°C</h3>
          <p className="text-slate-600 leading-relaxed">
            Para garantir a segurança biológica e a eliminação do <span className="text-slate-900 font-semibold italic">Trypanosoma cruzi</span> (causador da Doença de Chagas), o processo de branqueamento deve manter a polpa em uma temperatura mínima de <span className="text-[#1E562F] font-bold">52.5°C por pelo menos 10 minutos (600 segundos)</span>.
          </p>
        </Card>

        <Card className="bg-white border-slate-200 p-8 space-y-4 shadow-sm">
          <div className="bg-red-50 w-12 h-12 rounded-xl flex items-center justify-center">
            <AlertCircle className="text-[#e41b13]" size={28} />
          </div>
          <h3 className="text-2xl font-bold text-slate-900">Riscos Biológicos</h3>
          <p className="text-slate-600 leading-relaxed">
      ...
      <Card className="bg-white border-slate-200 p-8 shadow-sm">
        <div className="flex items-start gap-4">
          ...
          <div className="space-y-2">
            <h4 className="text-lg font-bold text-slate-900">Nota Técnica</h4>
